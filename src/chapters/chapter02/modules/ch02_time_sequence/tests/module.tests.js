(function installTimeSequenceModuleTests(global) {
  "use strict";
  const platform = global.ECTPPlatform = global.ECTPPlatform || {};
  platform.moduleTests = platform.moduleTests || {};
  platform.moduleTests.ch02_time_sequence = function run(instance) {
    ...
    return { moduleId: "ch02_time_sequence", passed: contract.valid && facade.valid && geometry.valid && solver.passed === solver.total, contract, facade, geometry, solver };
  };
})(globalThis);
